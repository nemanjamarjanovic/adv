...
public class SensorData {
    ...
    public SensorData(Long id, String serialNumber, Timestamp time, Double temperature, Double humidity,
            Integer co2, Boolean airConditionerAcitve, Boolean ventilatorActive, Integer mod) {
        this.id = id;
    ...
    public Boolean getAirConditionerAcitve() {
    ...
    public String toString() {
        return "SensorData{" + "id=" + id + ", serialNumber="
                + serialNumber + ", time=" + time + ", temperature="
                + temperature + ", humidity=" + humidity + ", co2="
                + co2 + ", airConditionerAcitve=" + airConditionerAcitve
                + ", ventilatorActive=" + ventilatorActive + ", mod=" + mod + '}';
    }
